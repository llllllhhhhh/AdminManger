...
export const defaultPages = [
  ...
  },
  {
    ...
    status: 'published',
    blocks: [
      { id: 'travel_smart', type: 'smart', name: '智能定制入口', visible: true, title: '一键生成专属路线', subtitle: '30 秒匹配你的积分预算与偏好', button: '开始定制', icon: '✦', iconColor: '#12a594', label: 'AI 智能匹配', labelColor: '#12a594', image: '', background: '#dff5ef', link: '/pages/custom/params' },
